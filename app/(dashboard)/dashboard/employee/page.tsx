...
import { getEmployeeDashboard } from '@/features/dashboard/lib/mock-dashboard';
...
export default function EmployeeDashboardPage() {
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 space-y-6 max-w-7xl mx-auto">
      <RoleSync role="employee" />
      {/* Welcome */}
      <WelcomeBanner name="Alex Johnson" role="employee" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Left: weekly hours + quick actions */}
        <div className="lg:col-span-2 space-y-6">
          {/* Weekly hours */}
          <div className="rounded-xl border border-border bg-card p-5">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-sm font-semibold text-foreground">Hours This Week</h2>
